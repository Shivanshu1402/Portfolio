  ...
  return (
    <section id='contactpage'>
            <div id="client">
                ...
                <p className='clientdiscription'> I had the opportunity to work with a diverse group of companies. Some of the notable companies I have Worked with includes</p>
